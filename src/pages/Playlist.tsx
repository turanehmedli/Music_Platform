          ...
          >
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 rounded-lg bg-green-500 hover:bg-green-600 disabled:opacity-40 disabled:cursor-not-allowed text-white font-semibold transition-colors transform hover:scale-105"
              >
                Create
              </button>
            </div>
            ...
            >
              ...
              <div className={`p-3 md:p-4 flex gap-2 border-t ${
                ...
                <button
                  ...
                  className="px-3 py-2 bg-red-500/20 hover:bg-red-500/40 text-red-500 rounded-lg transition-colors"
                >
                  <Trash2 size={16} />
                </button>
              </div>
